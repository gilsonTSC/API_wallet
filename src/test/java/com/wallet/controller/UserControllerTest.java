...
public class UserControllerTest {
	...
	public void testSave() throws Exception {
		...
		BDDMockito.given(this.service.save(Mockito.any(User.class))).willReturn(getMockUser());
		
		mvc.perform(MockMvcRequestBuilders.post(URI).content(this.getJsonPayLoad(ID, EMAIL, NAME, PASSWORD))
	...
	public void testSaveInvalidUser() throws JsonProcessingException, Exception {
		mvc.perform(MockMvcRequestBuilders.post(URI).content(this.getJsonPayLoad(ID, "email", NAME, PASSWORD))
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON))
		.andExpect(status().isBadRequest()) // ERROR 404
